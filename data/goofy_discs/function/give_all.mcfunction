...
loot give @s loot goofy_discs:discs/machine_girl_downgr4de_remix
...
loot give @s loot goofy_discs:discs/fukouna_girl_kt_vocaloid
loot give @s loot goofy_discs:discs/feels_right
loot give @s loot goofy_discs:discs/eternal_dream
...
loot give @s loot goofy_discs:discs/bosnia
