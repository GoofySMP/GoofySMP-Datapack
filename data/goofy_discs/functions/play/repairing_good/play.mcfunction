...
title @a[distance=..64] actionbar {"text":"Now Playing: walter - repairing good","color":"green"}
playsound goofy_smp:music_disc.repairing_good record @a[distance=..64] ~ ~ ~ 4 1
