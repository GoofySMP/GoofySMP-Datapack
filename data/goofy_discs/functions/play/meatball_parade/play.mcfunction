...
title @a[distance=..64] actionbar {"text":"Now Playing: Kevin Macleod - Meatball Parade","color":"green"}
playsound goofy_smp:music_disc.meatball_parade record @a[distance=..64] ~ ~ ~ 4 1
