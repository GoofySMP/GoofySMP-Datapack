...
title @a[distance=..64] actionbar {"text":"Now Playing: Vane Lily - BUTCHER VANITY","color":"green"}
playsound goofy_smp:music_disc.butcher_vanity record @a[distance=..64] ~ ~ ~ 4 1
