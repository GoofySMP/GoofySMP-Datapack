...
title @a[distance=..64] actionbar {"text":"Now Playing: Lucas Pope - Glory to Arstotzka (Papers, Please theme) ","color":"green"}
playsound goofy_smp:music_disc.papers_please_theme record @a[distance=..64] ~ ~ ~ 4 1
