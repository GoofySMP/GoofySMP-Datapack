...
title @a[distance=..64] actionbar {"text":"Now Playing: Daisuke Ishiwatari - The Town Inside Me","color":"green"}
playsound goofy_smp:music_disc.the_town_inside_me record @a[distance=..64] ~ ~ ~ 4 1
