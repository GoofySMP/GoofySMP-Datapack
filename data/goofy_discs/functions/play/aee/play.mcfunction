...
title @a[distance=..64] actionbar {"text":"Now Playing: Benlab - An Enigmatic Encounter","color":"green"}
playsound goofy_smp:music_disc.an_enigmatic_encounter record @a[distance=..64] ~ ~ ~ 4 1
