...
title @a[distance=..64] actionbar {"text":"Now Playing: Benlab - The Slaughter Continues","color":"green"}
playsound goofy_smp:music_disc.the_slaughter_continues record @a[distance=..64] ~ ~ ~ 4 1
