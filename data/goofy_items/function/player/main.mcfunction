...
execute if entity @e[type=wither,distance=..32] if predicate goofy_items:item/withering_blade_offhand run item modify entity @s weapon.offhand goofy_items:withering_blade/wither
execute unless entity @e[type=wither,distance=..32] if predicate goofy_items:item/withering_blade_offhand run item modify entity @s weapon.offhand goofy_items:withering_blade/no_wither
