...
execute if score @s gf.ray_steps < #dragonsbane_warp gf.config at @s run tp ^ ^ ^.25
scoreboard players add @s gf.ray_steps 1

#if score0, end
execute if score @s gf.ray_steps >= #dragonsbane_warp gf.config at @s run function goofy_items:item/dragonsbane/ray/end

#call func again, if steps remaining
execute if score @s gf.ray_steps < #dragonsbane_warp gf.config at @s run function goofy_items:item/dragonsbane/ray/step