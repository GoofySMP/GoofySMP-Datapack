...
$execute if score #1 md.numbers matches $(end) run tellraw @a[tag=gf.dev] {"text":"Ray: Found Entities","hoverEvent": {"action": "show_text","contents": {"selector": "@e[type=#uthi:ray_contact,dx=1]"}}}
